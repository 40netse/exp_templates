...
availability_zones = ["us-west-1b", "us-west-1c"] # e.g. ["us-east-2a", "us-east-2b"]
...
asgs = {
  fgt_byol_asg = {
      ...
      fgt_version = "7.2"
      license_type = "byol"
      fgt_password = "pP@ssw0rd321" # e.g. "fortinet"
      keypair_name = "us-west1-fgallego" # Keypair should be created manually
      #lic_folder_path = "./license"
      fortiflex_refresh_token = "iSbEz2v56X23yEGOo3XCNfFzNRyYV7" # e.g. "NasmPa0CXpd56n6TzJjGqpqZm9Thyw"
      fortiflex_sn_list = ["FGVMMLTM23014820", "FGVMMLTM23014821"] # e.g. ["FGVMMLTM00000001", "FGVMMLTM00000002"]
      fortiflex_configid_list = [7800] # e.g. [2343]
...
#   # This is optional. The module will create Transit Gateway Attachment under each subnet in argument 'subnet_ids', and also create route table to let all traffic (0.0.0.0/0) forward to the TGW attachment with the subnets associated.
  "spk_vpc1" = {
    ...
    subnet_ids = [
      "subnet-0d8f93e78a70027da",
      "subnet-017ad1b5787291350"
    ]
  }
}
